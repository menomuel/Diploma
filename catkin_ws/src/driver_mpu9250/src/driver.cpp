...
void driver::initialize(unsigned int i2c_bus, unsigned int i2c_address, unsigned int interrupt_gpio_pin)
{
    ...
    try
    {
        if(read_mpu9250_register(register_mpu9250_type::WHO_AM_I) != 0x73)
        {
...
float driver::p_dlpf_frequencies(gyro_dlpf_frequency_type gyro_frequency, accel_dlpf_frequency_type accel_frequency, float max_sample_rate)
{
    ...
    std::cout << "gyro_dlpf_frequency: " << gyro_dlpf_frequency << std::endl;
	std::cout << "accel_dlpf_frequency: " << accel_dlpf_frequency << std::endl;
	
	std::cout << "dlpf_frequency: " << dlpf_frequency << std::endl;
    std::cout << "max_sample_rate: " << max_sample_rate << std::endl;
   
    std::cout << "desired_frequency: " << desired_frequency << std::endl;
	std::cout << "internal_frequency: " << internal_frequency << std::endl;
	std::cout << "frequency_divider: " << (int)frequency_divider << std::endl;
